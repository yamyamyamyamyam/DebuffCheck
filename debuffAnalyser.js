function processInput() {
  ...
  try {
    ...
    debuffData.open("Get", baseURL + "/events/debuffs/" + logID + "?start=0&end=900000000&hostility=1&wipes=2" + filter + API, false);
    ...
    while (nextTime>1) {
      ...
      dataadd.open("Get", baseURL + "/events/debuffs/" + logID + "?start=" + nextTime + "&end=900000000&hostility=1&wipes=2" + filter + API, false);
      dataadd.send(null);
